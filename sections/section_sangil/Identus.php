...
<center>
<!--............................IMAGEN PRINCIPAL.........................-->
 <img src="../../res/img/gruposInv/banner_identus.jpg">
    ...
    <div class="panel-heading" role="tab" id="headingFour">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          Patentes  <div> <label id="contadorPatente" class="contador"></label></div>
        </a>
      </h4>
    </div>
          ...
          <?php
            ...
            foreach ($rows as $row) {
              # code...
                ?>
                 <tr>                 
                <td><?php print($contadorPatente =$contadorPatente +1); ?></td>
...
<script type="text/javascript">
    $(function numero() {
     ...
     document.getElementById("contadorLibro").innerHTML = <?php echo $contadorLibro?>; 
      document.getElementById("contadorPatente").innerHTML = <?php echo $contadorPatente?>; 
         } );
    </script>
